...
use Licweb\LocationBundle\Model\map\LocationTableMap;
...
abstract class BaseLocationPeer
{
    ...
    const OM_CLASS = 'Licweb\\LocationBundle\\Model\\Location';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Street', 'Zipcode', 'City', 'Presentation', 'Phonenumber', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'street', 'zipcode', 'city', 'presentation', 'phonenumber', ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID, LocationPeer::NAME, LocationPeer::STREET, LocationPeer::ZIPCODE, LocationPeer::CITY, LocationPeer::PRESENTATION, LocationPeer::PHONENUMBER, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'STREET', 'ZIPCODE', 'CITY', 'PRESENTATION', 'PHONENUMBER', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'street', 'zipcode', 'city', 'presentation', 'phoneNumber', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Street' => 2, 'Zipcode' => 3, 'City' => 4, 'Presentation' => 5, 'Phonenumber' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'street' => 2, 'zipcode' => 3, 'city' => 4, 'presentation' => 5, 'phonenumber' => 6, ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID => 0, LocationPeer::NAME => 1, LocationPeer::STREET => 2, LocationPeer::ZIPCODE => 3, LocationPeer::CITY => 4, LocationPeer::PRESENTATION => 5, LocationPeer::PHONENUMBER => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'STREET' => 2, 'ZIPCODE' => 3, 'CITY' => 4, 'PRESENTATION' => 5, 'PHONENUMBER' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'street' => 2, 'zipcode' => 3, 'city' => 4, 'presentation' => 5, 'phoneNumber' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationPeer::STREET);
            $criteria->addSelectColumn(LocationPeer::ZIPCODE);
            $criteria->addSelectColumn(LocationPeer::CITY);
            $criteria->addSelectColumn(LocationPeer::PRESENTATION);
            $criteria->addSelectColumn(LocationPeer::PHONENUMBER);
        } else {
