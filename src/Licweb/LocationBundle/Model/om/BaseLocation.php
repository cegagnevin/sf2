...
abstract class BaseLocation extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Licweb\\LocationBundle\\Model\\LocationPeer';
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[] = LocationPeer::STREET;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[] = LocationPeer::ZIPCODE;
        }
    ...
    public function setPresentation($v)
    {
        ...
        if ($this->presentation !== $v) {
            $this->presentation = $v;
            $this->modifiedColumns[] = LocationPeer::PRESENTATION;
        }
    ...
    public function setPhonenumber($v)
    {
        ...
        if ($this->phonenumber !== $v) {
            $this->phonenumber = $v;
            $this->modifiedColumns[] = LocationPeer::PHONENUMBER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->presentation = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->phonenumber = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = LocationPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LocationPeer::STREET)) {
            $modifiedColumns[':p' . $index++]  = '`street`';
        }
        if ($this->isColumnModified(LocationPeer::ZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = '`zipcode`';
        }
        if ($this->isColumnModified(LocationPeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(LocationPeer::PRESENTATION)) {
            $modifiedColumns[':p' . $index++]  = '`presentation`';
        }
        if ($this->isColumnModified(LocationPeer::PHONENUMBER)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setPresentation($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocationPeer::STREET)) $criteria->add(LocationPeer::STREET, $this->street);
        if ($this->isColumnModified(LocationPeer::ZIPCODE)) $criteria->add(LocationPeer::ZIPCODE, $this->zipcode);
        if ($this->isColumnModified(LocationPeer::CITY)) $criteria->add(LocationPeer::CITY, $this->city);
        if ($this->isColumnModified(LocationPeer::PRESENTATION)) $criteria->add(LocationPeer::PRESENTATION, $this->presentation);
        if ($this->isColumnModified(LocationPeer::PHONENUMBER)) $criteria->add(LocationPeer::PHONENUMBER, $this->phonenumber);
    ...
    public function setComments(PropelCollection $comments, PropelPDO $con = null)
    {
        ...
        foreach ($commentsToDelete as $commentRemoved) {
            $commentRemoved->setLocation(null);
        }
