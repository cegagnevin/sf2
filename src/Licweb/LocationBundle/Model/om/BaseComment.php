...
abstract class BaseComment extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Licweb\\LocationBundle\\Model\\CommentPeer';
    ...
    /**
     * The value for the idlocation field.
     * @var        int
     */
    ...
    /**
     * Get the [idlocation] column value.
     *
     * @return int
     */
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = CommentPeer::MESSAGE;
        }
    ...
    /**
     * Set the value of [idlocation] column.
     *
     * @param int $v new value
     * @return Comment The current object (for fluent API support)
     */
    public function setIdlocation($v)
    {
        ...
        if ($this->idlocation !== $v) {
            $this->idlocation = $v;
            $this->modifiedColumns[] = CommentPeer::IDLOCATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idlocation = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = CommentPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aLocation !== null && $this->idlocation !== $this->aLocation->getId()) {
            $this->aLocation = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommentPeer::AUTHOR)) {
            $modifiedColumns[':p' . $index++]  = '`author`';
        }
        if ($this->isColumnModified(CommentPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(CommentPeer::IDLOCATION)) {
            $modifiedColumns[':p' . $index++]  = '`idLocation`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`message`':
                        ...
                        break;
                    case '`idLocation`':
                        $stmt->bindValue($identifier, $this->idlocation, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIdlocation($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentPeer::MESSAGE)) $criteria->add(CommentPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(CommentPeer::IDLOCATION)) $criteria->add(CommentPeer::IDLOCATION, $this->idlocation);
    ...
    {
        if ($v === null) {
            $this->setIdlocation(NULL);
        } else {
            $this->setIdlocation($v->getId());
        }
    ...
    {
        if ($this->aLocation === null && ($this->idlocation !== null) && $doQuery) {
            $this->aLocation = LocationQuery::create()->findPk($this->idlocation, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLocation->addComments($this);
             */
        }
     ...
     *
     * @return string The value of the 'author' column
     */
