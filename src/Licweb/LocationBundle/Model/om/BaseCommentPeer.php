...
use Licweb\LocationBundle\Model\map\CommentTableMap;
...
abstract class BaseCommentPeer
{
    ...
    const OM_CLASS = 'Licweb\\LocationBundle\\Model\\Comment';
    ...
    /** the column name for the idLocation field */
    const IDLOCATION = 'comment.idLocation';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Author', 'Message', 'Idlocation', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'author', 'message', 'idlocation', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::AUTHOR, CommentPeer::MESSAGE, CommentPeer::IDLOCATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'AUTHOR', 'MESSAGE', 'IDLOCATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'author', 'message', 'idLocation', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Author' => 1, 'Message' => 2, 'Idlocation' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'author' => 1, 'message' => 2, 'idlocation' => 3, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::AUTHOR => 1, CommentPeer::MESSAGE => 2, CommentPeer::IDLOCATION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'AUTHOR' => 1, 'MESSAGE' => 2, 'IDLOCATION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'author' => 1, 'message' => 2, 'idLocation' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::MESSAGE);
            $criteria->addSelectColumn(CommentPeer::IDLOCATION);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.author');
            $criteria->addSelectColumn($alias . '.message');
            $criteria->addSelectColumn($alias . '.idLocation');
        }
    }
    ...
    public static function doCountJoinLocation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::IDLOCATION, LocationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Location objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinLocation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Location)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Location)
                $obj2->addComment($obj1);
